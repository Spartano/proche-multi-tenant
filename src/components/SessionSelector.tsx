      ...
      <div className="p-fluid-md pb-0">
        <ExerciseInfo title="Session Simulator — Interviewer Controls">
          <p>
            ...
            <strong> without a real backend</strong>. Changing the <strong>Tenant</strong> should swap
            branding (logo, favicon, page title). Changing the <strong>User Role</strong> and{' '}
            <strong>Tier</strong> should affect which navigation items appear and which routes are accessible.
            Right now nothing reacts to these changes — that's what the candidate needs to implement.
          </p>
        </ExerciseInfo>
      </div>
