    ...
    >
      <ExerciseInfo title="Reports — Access Rules">
        ...
        <p>
          ...
          On Tier 1, even Admins and Analysts won't see this in the navigation, and directly
          navigating to <code>/reports</code> will redirect to Access Denied. This page validates
          that both role AND tier checks work together.
        </p>
      </ExerciseInfo>
